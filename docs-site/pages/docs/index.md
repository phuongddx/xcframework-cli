...
| Feature | Status |
|---------|--------|
| Xcode Projects (`.xcodeproj` / `.xcworkspace`) | Supported |
| Swift Packages (`Package.swift`) | Supported |
| iOS Device + Simulator | Supported |
| Resource Bundles (fonts, images, JSON) | Supported |
| YAML/JSON Configuration | Supported |
| Custom Build Settings | Supported |
| Colored build output (`xcbeautify`) | Supported |
...
See the [Roadmap](/docs/project-roadmap) for details.
