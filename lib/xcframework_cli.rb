...
require_relative 'xcframework_cli/utils/template'
...
require_relative 'xcframework_cli/spm/framework_slice'
require_relative 'xcframework_cli/spm/xcframework_builder'
require_relative 'xcframework_cli/xcodebuild/formatter'
